...
This library aims to extract all that code into a group of reusable classes, or "Behaviors" that can be combined to quickly provide a ton of functionality to various UI classes.
...
3. Add more (a lot more) behaviors.
   * Add camera to the image picker
   * Add "last photo taken" to image picker
